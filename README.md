...
de développement pour l'apprentissage automatique sur les dispositifs embaqués. Ce projet est le prmeier d'une longue listes d'expérimentations sur le sujet de Tiny que je viens de découvrir et qui m'intéresse de plus en plus.
...
|Portabilité : Permet l'intégration dans de petits appareils non connectés ou dans des endroits isolés.| Domaine émergent : Moins de standardisation et d'outils matures par rapport à l'IA traditionnelle (pour
le moment)
...
<p align="center">
  <img alt="Accéléromètre" src="assets/Accéléromètre.png.png" width="250px">
</p>